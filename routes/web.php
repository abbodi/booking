...
Route::get('/terms_and_conditions', [TermsController::class, 'index'])->name('terms');
...
Route::get('/pp', [AdminHomeController::class, 'pp']);
...
Route::get('/admin/photo-gallery', [AdminPageController::class, 'photo_gallery'])->name('admin_page_photo_gallery');
Route::post('/admin/photo-gallery', [AdminPageController::class, 'photo_gallery_update'])->name('admin_page_photo_gallery_update');

Route::get('/admin/video-gallery', [AdminPageController::class, 'video_gallery'])->name('admin_page_video_gallery');
Route::post('/admin/video-gallery', [AdminPageController::class, 'video_gallery_update'])->name('admin_page_video_gallery_update');
