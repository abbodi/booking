...
@section('heading', 'Edit Policy and Privacy Page')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="privacy_content" class="form-control snote" id="" cols="30" rows="10">{{ $page_data->privacy_content }}</textarea>
                                </div>
